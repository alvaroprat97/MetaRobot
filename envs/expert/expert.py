...
# Environment
task_families = ["Key2Dv"]
env = ENV(expert = True, task_families=task_families)
...
if __name__ == "__main__":
    RL_trainer = MultiTaskRLAlgorithm(env, agent, task_name=task_families[0], **variant['algorithm_kwargs']) 
