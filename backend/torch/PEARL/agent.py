...
class PEARLAgent(nn.Module):
    ...
    def update_behaviour_policy(self):
        ptu.copy_model_params_from_to(self.policy, self.behaviour_policy)
    ...
    def encoder_log_probs(self, enc_context, target_latent_space):
        ...
        return log_probs.permute(1,0,2).sum(dim = [1,2], keepdim = True)
    ...
    def bc_forward(self, demo_obs, demo_acts, aux_targets = None, aux_no_grad = False):
        '''
