...
default_config = dict(
    ...
    net_size=128, # Was 32 # number of units per FC layer in each network
    ...
    algo_params=dict(
        ...
        num_initial_steps=200//8, # number of transitions collected per task before training
    ...
    aux_params = dict(
        ...
        beta = 1, # weighted importance of aux loss contribution to critic contribution for encoder
